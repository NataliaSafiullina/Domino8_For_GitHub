ETK\Admin
 ...
 29163536[164888702]                 Отображаемый текст для объектов БД ≡ Наименование ∙ 283[5] ←
  ...
  2621481[164888630]                 Доступно (видимо), если: ≡ Видимость дат ∙ 117[164888803] ←
      323[164888663]                 Обязательное для ввода поле ←
 ...
 11010080[164891151]           = ≡ Дата конечная для проверки ∙ 65545[164890362] ←
  ...
  1507728[170721326]       Начало многострочного комментария ←
 11010088[170721440]       ВЫПОЛНИТЬ ≡ HTTP WEB.Послать сообщение и получить ответ ∙ 249[10813624] ←
 33161308[170721283]         Адрес сервера ( URL ИЛИ IP ) ⁼ '172.16.10.252/api/task' ←
 33161307[170721283]         Сообщение ≡ лп JSON для API CCC ∙ 65545[170721558] ←
  8847724[170721283]         Ответное сообщение ≡ лп Ответ ССС ∙ 65545[170721560] ←
 10813601[170721282]         ContentType ⁼ 'application/json' ←
 10813610[170721282]         Keep-Alive ≡ false ∙ 117[30867469] ←
 10813607[170721282]         Encoding ≡ UTF8 ∙ 10813604[10813444] ←
 10813609[170721282]         Header Item ⁼ 'Authorization: Basic aW5mbGV0dGVyOmpndGh5c3FudGZudGg=' ←
  1507729[170721326]       Конец многострочного комментария ←
  ...
  1507674[164888588]           <Наследуемые пункты> ←
 ...
 12124215[164888719]         Where      (Ограничения на отбор данных) ←
  ...
  1507494[171312171]               Уточняющий параметр ≡ ПРИЗНАК_ФИНХОЗ ∙ 1507443[171507713] ←
  1638473[171311851]             Равно ←
  1507452[171311571]             Константа ⁼ 1 ←
  ...
  1507455[164889792]             Результат ∙ 12124204[164888764] ←
  1507494[164890231]               Уточняющий параметр ≡ Партнер ∙ 283[1] ←
 ...
 12124215[164888982]               Where      (Ограничения на отбор данных) ←
  ...
  1507506[171311257]             Использование (в режиме выполнения) ≡ Нет ∙ 534[11599875] ←
 12124213[164888630]         Параметры ←
  ...
  1507335[164888751]           Параметр • з.товар ∙ 12124204[164888653] ←
  1507494[164889311]             Уточняющий параметр ≡ ПРОДУКТ ∙ 1507443[43122766] ←
 ...
 11010095[170721313]               Выражение ←
  ...
  1507728[170721325]             Начало многострочного комментария ←
 11010088[170721454]             ВЫПОЛНИТЬ ≡ WriteMessageToLog ∙ 127[39780364] ←
 11010095[170721320]               Выражение ←
      404[170722642]                 Результат ≡ лп JSON для API CCC ∙ 65545[170721558] ←
 30867470[170721360]             IF ←
  1638463[170721375]               Условие ←
      404[170722438]                 Результат ≡ Save2File ∙ 387[59375713] ←
 32505862[170721511]                   Значения формальных параметров при вызове ←
 32505860[170721730]                     Значение параметра при вызове процедуры/функции ≡ Файл ∙ 65545[59379743] ←
   327700[170721779]                       Выражение ≡ лп JSON файл ∙ 65545[170721559] ←
 32505860[170721731]                     Значение параметра при вызове процедуры/функции ≡ Значение ∙ 65545[59379744] ←
   327700[170721782]                       Выражение ≡ лп JSON для API CCC ∙ 65545[170721558] ←
 30867472[170721360]               THEN ←
 11010088[170721435]                 ВЫПОЛНИТЬ ≡ WriteMessageToLog ∙ 127[39780364] ←
 11010095[170721311]                   Выражение ←
      404[170722439]                     Результат ⁼ Файл сохранён ←
 30867473[170721311]               ELSE ←
 11010088[170721438]                 ВЫПОЛНИТЬ ≡ WriteMessageToLog ∙ 127[39780364] ←
 11010095[170721312]                   Выражение ←
      404[170722440]                     Результат ⁼ Ошибка сохранения ←
  1507729[170721325]             Конец многострочного комментария ←
